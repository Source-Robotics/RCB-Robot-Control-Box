...
void ADC_CHANNEL_4_SELECT_VBUS2(void){
    // Select ADC channel
  ADC_ChannelConfTypeDef sConfig = {0};
...
/// @param  
/// @return 
int ADC_CHANNEL_4_READ_VBUS2(void){

  ADC_CHANNEL_4_SELECT_VBUS2();
...
/// @brief 
/// @param  
void ADC_CHANNEL_3_SELECT_CURRENT(void){
    // Select ADC channel
  ADC_ChannelConfTypeDef sConfig = {0};
...
/// @param  
/// @return 
int ADC_CHANNEL_3_READ_CURRENT(void){

  ADC_CHANNEL_3_SELECT_CURRENT();
  // Read selected ADC channel
  HAL_ADC_Start(&hadc1);
  // Poll ADC1 Perihperal & TimeOut = 1mSec
  HAL_ADC_PollForConversion(&hadc1, 1);
...
/// @brief 
/// @param  
void ADC_CHANNEL_5_SELECT_VBUS1(void){
    // Select ADC channel
  ADC_ChannelConfTypeDef sConfig = {0};
...
/// @param  
/// @return 
int ADC_CHANNEL_5_READ_VBUS1(void){

  ADC_CHANNEL_5_SELECT_VBUS1();
  // Read selected ADC channel
  HAL_ADC_Start(&hadc1);
  // Poll ADC1 Perihperal & TimeOut = 1mSec
  HAL_ADC_PollForConversion(&hadc1, 1);
